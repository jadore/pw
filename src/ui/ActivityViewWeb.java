...
public class ActivityViewWeb extends AppActivity {
	private WebView webView;
	private ProgressDialog loadingPd;
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.phonebook_view_webview);
		initUI();
		initData();
	}
	...
	Handler mJSHandler = new Handler(){
		public void handleMessage(Message msg) {
			...
			case CommonValue.CreateViewJSType.goPhonebookView:
				...
				AppManager.getAppManager().finishActivity(ActivityViewWeb.this);
				break;
